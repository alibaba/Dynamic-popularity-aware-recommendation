...
import pandas as pd
import itertools
from model_code.deep_u2i_fullsoftmax import model_fn
...
np.save("itemid_vectors_fullsoftmax.npy", id_vectors)
np.save("itemid_index_fullsoftmax.npy", id_index)
...
id_vectors = np.array(id_vectors)
id_index = np.array(id_index)
np.save("userid_vectors_fullsoftmax.npy", id_vectors)
np.save("userid_index_fullsoftmax.npy", id_index)
